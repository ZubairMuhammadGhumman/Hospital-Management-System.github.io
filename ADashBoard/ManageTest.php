...
if(isset($_POST['Add']))
{
  ...
  }else
  {
    ...
    header("Location: http://localhost/HMS/ADashboard/ManageTest.php");
  }
...
<form style="margin-left: 570px;" action="<?php echo htmlspecialchars($_SERVER["PHP_SELF"]); ?>" method="POST">
<input type="text" name="test" value="<?php $test ?>">
